        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between ">
                    ...
                    <button type="button" class="close" aria-label="Close" onclick="window.location.href='{{ route('returns.index') }}';">
                ...
                <div class="content-page2">
                    <div class="bottom-nav d-flex">
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <a class="btn btn-danger" href="{{ route('returns.updateStatus', ['id' => $return->id, 'status' => 'Returned']) }}">Mark As Returned</a>
                        </div>
                        @endif
